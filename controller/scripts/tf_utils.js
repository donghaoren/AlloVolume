var Gradients = {
    ...
    "gist_ncar": { name: "gist_ncar", values: [
        [ 0.0000, 0.0000, 0.5020 ],
        [ 0.0000, 0.3434, 0.0593 ],
        [ 0.0000, 0.0533, 0.8044 ],
        [ 0.0000, 0.6089, 1.0000 ],
        [ 0.0000, 0.9308, 1.0000 ],
        [ 0.0000, 0.9840, 0.6913 ],
        [ 0.0000, 0.9918, 0.2458 ],
        [ 0.2498, 0.8818, 0.0000 ],
        [ 0.4538, 0.9104, 0.0000 ],
        [ 0.6254, 1.0000, 0.1405 ],
        [ 0.8574, 1.0000, 0.1248 ],
        [ 1.0000, 0.9324, 0.0000 ],
        [ 1.0000, 0.8066, 0.0211 ],
        [ 1.0000, 0.5688, 0.0366 ],
        [ 1.0000, 0.2051, 0.0000 ],
        [ 1.0000, 0.0000, 0.2774 ],
        [ 0.9463, 0.0269, 1.0000 ],
